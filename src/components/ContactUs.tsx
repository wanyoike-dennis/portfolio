...
export default function ContactUs(){
    ...
    return(
        <div className="bg-[#1f1f21] min-h-screen flex items-center">
        <div className="max-w-6xl mx-auto bg-[#474647] rounded-lg p-6 sm:p-12">
          <div className="grid lg:grid-cols-2 items-center gap-14">
                <div>
                    <h1 className="text-4xl font-bold text-white">Get in touch</h1>
                    <p className="text-sm text-white mt-4 leading-relaxed">Have some big ideaa or brand to develop and need help ?
                    ...
                    <ul className="flex mt-12 space-x-4">
                        <li className="bg-[#ffae00] hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                ...
                <div className="bg-[#] p-6 rounded-lg">
                    ...
                    <div className="space-y-4 max-lg:mt-4">
                        <button type="button" className="px-4 py-2 rounded-lg bg-[#ffae00] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#ffae00] mr-4">Web design</button>
                        <button type="button" className="px-4 py-2 rounded-lg bg-transparent text-white text-sm tracking-wider font-medium outline-none border border-[#ffae00] mr-4">Android App</button>
                        <button type="button" className="px-4 py-2 rounded-lg bg-transparent text-white text-sm tracking-wider font-medium outline-none border border-[#ffae00] mr-4">Design system</button>

                    </div>
                    
                    <form className="bg-[#1f1f21] p-6 rounded-lg shadow-lg space-y-6 my-1">
            <div>
              ...
              <input
                ...
                className="w-full mt-2 px-4 py-2 rounded-lg bg-[#2a2a2c] text-white outline-none focus:ring-2 focus:ring-[#ffae00]"
              />
            </div>
            <div>
            ...
            <button
              type="submit"
              className="w-full py-2 bg-[#ffae00] text-white rounded-lg hover:bg-[#e69e00] transition"
            >
              Send Message
            </button>
          </form>
