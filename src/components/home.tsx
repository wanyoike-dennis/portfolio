...
export default function HomePage({ projects }: ProjectsListProps) {
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 text-center relative z-10">
          ...
          <p className="text-xl mb-8">
            Crafting innovative solutions in web and mobile development, AI, and
            more.
          </p>
          <Link
            to="/about"
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            <div className="bg-[#3a3a3c] p-8 rounded-xl shadow-lg hover:shadow-xl transition">
              <h3 className="text-2xl font-semibold text-[#ffae00] mb-4">
                Web Development
              </h3>
              <p className="text-gray-300">
                Creating responsive, user-friendly websites with a focus on
            ...
            <div className="bg-[#3a3a3c] p-8 rounded-xl shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-300">
                Building native Android apps with modern tools and technologies
            ...
            <div className="bg-[#3a3a3c] p-8 rounded-xl shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-300">
                Leveraging machine learning algorithms to build intelligent
      ...
      <section className="py-16 bg-[#2a2a2c] min-h-screen flex flex-col items-center justify-center">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Whether you have a question, idea, or want to collaborate on a
            project, I'm always open to hearing from you. Don't hesitate to
            reach out!
          </p>
